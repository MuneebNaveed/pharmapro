        ...
        <React.Fragment>
            <div className="media user-profile mt-2 mb-2">
                ...
                <div className="media-body">
                    <h6 className="pro-user-name mt-0 mb-0">{user ? user.username : 'Fetching'}</h6>
                    <span className="pro-user-desc">{user ? user.role : 'Fetching'}</span>
                </div>
        ...
        return (
            <React.Fragment>
                <div className="left-side-menu" ref={(node) => (this.menuNodeRef = node)}>
                    <UserProfile user={this.state.loggedInUser} />
                    {!isCondensed && (
                        <PerfectScrollbar>
                            <SideNav />
                        </PerfectScrollbar>
